...
using static ElementClass;
using static ShopLogic;

public class OracleCardUI : MonoBehaviour
{
    private GameObject shopWindow;
    public Animator animator;
    public TextMeshProUGUI elementText;
    public ElementMultiplierConfig scoringAreaElement;
    public Collider objectCollider;
    private bool isSelected;

    [SerializeField]
    private ElementClass.ElementType elementType; // Element type for testing
    ...
    public void SetData(ElementMultiplierConfig element)
    {
        scoringAreaElement = element;
